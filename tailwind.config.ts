  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        elevated:
          "0 1px 0 0 hsl(0 0% 100% / 0.07) inset, 0 18px 40px -20px hsl(213 40% 3% / 0.8)",
        float:
          "0 1px 0 0 hsl(0 0% 100% / 0.09) inset, 0 30px 70px -28px hsl(213 40% 3% / 0.9)",
        "gold-glow":
          "0 0 0 1px hsl(var(--gold) / 0.35), 0 12px 40px -12px hsl(var(--gold) / 0.35)",
      },
